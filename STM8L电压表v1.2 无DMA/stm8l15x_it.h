/**
  ******************************************************************************
  * @file    STM8L151C3_Ex01\inc\stm8l15x_it.h
...
/* Exported functions ------------------------------------------------------- */
 ...
 INTERRUPT void RI_IRQHandler(void);/* Routing Interface */
 INTERRUPT void TIM1_CC_IRQHandler(void);/* TIM1 CAP*/
//INTERRUPT void TIM4_UPD_OVF_IRQHandler(void); /* TIM4 UPD/OVF */
 INTERRUPT void TSL_Timer_ISR(void); /* STMTouch Driver - Timing module */
