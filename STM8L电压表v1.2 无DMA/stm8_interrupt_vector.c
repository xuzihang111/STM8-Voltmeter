/**
  ******************************************************************************
  * @file    STM8L151C3_Ex01\src\stm8_interrupt_vector.c
...
struct interrupt_vector const _vectab[] = {
  ...
  {0x82, (interrupt_handler_t)RI_IRQHandler}, /* irq23 - Routing Interface interrupt */
...
//{0x82, (interrupt_handler_t)TIM4_UPD_OVF_TRG_IRQHandler}, /* irq25 - TIM4 Update/Overflow/Trigger interrupt */
  {0x82, (interrupt_handler_t)TSL_Timer_ISR}, /* irq25 - TIM4 Update/Overflow/Trigger interrupt */
